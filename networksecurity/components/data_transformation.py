...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """
        It initiliase the the KNN imputer object withthe paramters specified in the training_pipeline.py file
        ...
        try:
           ...
           logging.info(
               "done the preprocessing and returning the file"
           )
           return processor
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            save_numpy_array_data(self.data_transformation_config.transformed_object_file_path,preprocessor_obj)
